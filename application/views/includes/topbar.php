        ...
        <ul class="header-actions">
                        ...
                        <li>
                            <a href="#">
                                <div class="user-img away">
                                    <img src="<?php echo base_url();?>assets/img/DOLE LOGO.png" alt="Bootstrap Admin Panel">
                                </div>
                                <div class="details">
                        ...
                        <li>
                            <a href="#">
                                <div class="user-img busy">
                                    <img src="<?php echo base_url();?>assets/img/DOLE LOGO.png" alt="Admin Panel">
                                </div>
                                <div class="details">
                        ...
                        <li>
                            <a href="#">
                                <div class="user-img online">
                                    <img src="<?php echo base_url();?>assets/img/DOLE LOGO.png" alt="Admin Template">
                                </div>
                                <div class="details">
            ...
            <li class="dropdown">
                <a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
                    <span class="user-name">DOLE ORMIN</span>
                    <span class="avatar">OR<span class="status busy"></span></span>
                </a>
